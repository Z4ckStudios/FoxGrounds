...
const data = {
    item1: localStorage.getItem("prevMsgs"),
    item2: localStorage.getItem("prevMsgText"),
    item3: localStorage.getItem("prevMsgPos"),
    item4: localStorage.getItem("iValue"),
    item5: localStorage.getItem("VNum")
};

// fetch("/api/FoxGroundsDB", {
//     method: "POST",
//     headers: {
